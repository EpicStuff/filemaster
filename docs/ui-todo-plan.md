...
| `charts` / connection charts                 | **Open and Execute Decisions over Time** | Two Portmaster-style graph panels: Open and Execute. Each shows allowed (green) and blocked (red) decisions.                             |
