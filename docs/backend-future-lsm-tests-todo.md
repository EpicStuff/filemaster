...
## Policy Routing and Default Hardening
...
7. Tests exercise these invariants through the complete production-style decision paths, not only the low-level routing helpers.
